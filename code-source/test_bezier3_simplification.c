...
int main(int argc, char * argv[])
{
    ...
    Tableau * contours_simplifier = Simplification_Bezier3(contours, atof(argv[3]));
    ...
    printf("Fin du teste\n");
            ...
            PsCourbeBezier3(contours_simplifier, dimention, argv[2]);
        
       TableauFree(&contours);
    TableauFree(&contours_simplifier);
